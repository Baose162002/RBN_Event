...
{
    public class CompanyCreateEvent : PageModel
    {
        private readonly HttpClient _httpClient;
        private readonly IConfiguration _configuration;
        private readonly ILogger<CompanyCreateEvent> _logger;

        public CompanyCreateEvent(HttpClient httpClient, IConfiguration configuration, ILogger<CompanyCreateEvent> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                ModelState.AddModelError(string.Empty, "Có lỗi gì đó. Vui lòng thử lại");
                return Page();
            }
        }
